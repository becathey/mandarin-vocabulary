  ...
  <div>
    ...
    <form action="#" @submit.prevent="onSubmit">
      <div class="ui labeled input fluid">
        <div class="ui label"><i class="china flag"></i> Mandarin</div>
        <input
          type="text"
          readonly
          :disabled="testOver"
          :value="currWord.mandarin"
        />
      </div>
      <div class="ui labeled input fluid">
        <div class="ui label">
        ...
        <input
          ...
          readonly
          :disabled="testOver"
          :value="currWord.pinyin"
        />
      </div>
      <div class="ui labeled input fluid">
        <div class="ui label"><i class="united states flag"></i> English</div>
        <input
          type="text"
  ...
  methods: {
    onSubmit: function() {
      if (this.english === this.currWord.english) {
        ...
        this.incorrectGuesses.push(this.currWord.mandarin);
      }
      this.english = "";
    ...
    displayResults: function() {
      if (this.incorrectGuesses.length === 0) {
        this.result = "You got everything correct!";
